...
async def async_setup_entry(
    ...
    switch_configs = [
        ...
        ("time_override_1_enabled", "Time Override Enabled", False, "mdi:clock-edit"),
        ("time_override_1_enabled_tomorrow", "Time Override Enabled Tomorrow", False, "mdi:clock-edit"),
